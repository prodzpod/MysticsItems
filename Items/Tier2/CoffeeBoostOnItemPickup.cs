...
namespace MysticsItems.Items
{
    public class CoffeeBoostOnItemPickup : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            HopooShaderToMaterial.Standard.Gloss(itemDef.pickupModelPrefab.transform.Find("¬¸¬Ú¬Ý¬Ú¬ß¬Õ¬â").Find("¬¸¬Ú¬Ý¬Ú¬ß¬Õ¬â.001").GetComponent<Renderer>().sharedMaterial, 0f);
            itemDisplayPrefab = PrepareItemDisplayModel(PrefabAPI.InstantiateClone(itemDef.pickupModelPrefab, itemDef.pickupModelPrefab.name + "Display", false));
            itemDef.pickupModelPrefab.transform.Find("¬¸¬Ú¬Ý¬Ú¬ß¬Õ¬â").Rotate(new Vector3(-30f, 0f, 0f), Space.Self);
            onSetupIDRS += () =>
            {
