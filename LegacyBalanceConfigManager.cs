...
namespace MysticsItems
{
    public static class LegacyBalanceConfigManager
    {
        public class ConfigurableValue<T> : ConfigOptions.ConfigurableValue<T>
        {
            ...
            {
                CreateInt(ConfigManager.Balance.categoryGUID, ConfigManager.Balance.categoryName, ConfigManager.Balance.config, section, key, defaultValue, min: 0, max: 1000000, description: description, stringsToAffect: stringsToAffect, useDefaultValueConfigEntry: ConfigManager.Balance.ignore.bepinexConfigEntry, onChanged: onChanged);
            }
            ...
            {
                CreateBool(ConfigManager.Balance.categoryGUID, ConfigManager.Balance.categoryName, ConfigManager.Balance.config, section, key, defaultValue, description: description, stringsToAffect: stringsToAffect, useDefaultValueConfigEntry: ConfigManager.Balance.ignore.bepinexConfigEntry, onChanged: onChanged);
            }
            ...
            {
                CreateString(ConfigManager.Balance.categoryGUID, ConfigManager.Balance.categoryName, ConfigManager.Balance.config, section, key, defaultValue, description: description, stringsToAffect: stringsToAffect, useDefaultValueConfigEntry: ConfigManager.Balance.ignore.bepinexConfigEntry, onChanged: onChanged);
            }
        }
    }
}
